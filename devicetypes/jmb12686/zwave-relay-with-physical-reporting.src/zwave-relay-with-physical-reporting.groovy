 ...
 *   of the latest official Z-Wave Relay DTH which still reports this data.
 *
 */
metadata {

	definition (name: "Z-Wave Relay With Physical Reporting", namespace: "jmb12686", author: "JohnBelisle") {
		capability "Actuator"
		capability "Switch"
		capability "Polling"
		capability "Refresh"
