...
metadata {
	definition(name: "Refreshable Z-Wave Door/Window Sensor", namespace: "jmb12686", author: "JohnBelisle", ocfDeviceType: "x.com.st.d.sensor.contact", minHubCoreVersion: '000.017.0012', executeCommandsLocally: false) {
...
def refresh() {
	log.debug "Refreshing status for ${device.name}"
	command(zwave.sensorBinaryV2.sensorBinaryGet(sensorType: zwave.sensorBinaryV2.SENSOR_TYPE_DOOR_WINDOW))
}
